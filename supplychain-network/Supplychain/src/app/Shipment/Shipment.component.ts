...
export class ShipmentComponent implements OnInit {
  ...
  tempratureReading = new FormControl('', Validators.required);
  ...
  constructor(public serviceShipment: ShipmentService, fb: FormBuilder) {
    this.myForm = fb.group({
      ...
      tempratureReading: this.tempratureReading,
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      ...
      'tempratureReading': this.tempratureReading.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.tempratureReading) {
        formObject.tempratureReading = result.tempratureReading;
      } else {
        formObject.tempratureReading = null;
      }
